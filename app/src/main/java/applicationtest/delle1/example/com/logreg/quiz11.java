...
public class quiz11 extends Activity {
  ...
  /*Random r;
    ...
    private Question11 mQuestionLibrary = new Question11();
    MediaPlayer son;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonChoice3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(quiz11.this,t11.class));
            }
        });
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(quiz11.this, "correcte", Toast.LENGTH_SHORT).show();

                    son= MediaPlayer.create(quiz11.this,R.raw.cor);
                    son.start();


                }else {
                    Toast.makeText(quiz11.this, "Faux", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
