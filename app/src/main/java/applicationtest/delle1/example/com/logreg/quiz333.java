...
public class quiz333 extends Activity {
  ...
  /*Random r;
    ...
    private Question333 mQuestionLibrary = new Question333();
    MediaPlayer son;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonChoice3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(quiz333.this,t333.class));
            }
        });
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(quiz333.this, "correcte", Toast.LENGTH_SHORT).show();

                    son= MediaPlayer.create(quiz333.this,R.raw.cor);
                    son.start();


                }else {
                    Toast.makeText(quiz333.this, "Faux", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
