...
public class quiz77 extends Activity {
/*Random r;
    @Override
    ...
    private Question77 mQuestionLibrary = new Question77();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonChoice3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(quiz77.this,t77.class));
            }
        });
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(quiz77.this, "correcte", Toast.LENGTH_SHORT).show();

                    son= MediaPlayer.create(quiz77.this,R.raw.cor);
                    son.start();


                }else {
                    Toast.makeText(quiz77.this, "Faux", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
