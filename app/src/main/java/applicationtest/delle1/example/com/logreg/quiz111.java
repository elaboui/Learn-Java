...
public class quiz111 extends Activity {
  ...
  /*Random r;
    ...
    private Question111 mQuestionLibrary = new Question111();
    MediaPlayer son;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonChoice3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(quiz111.this,t111.class));
            }
        });
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(quiz111.this, "correcte", Toast.LENGTH_SHORT).show();

                    son= MediaPlayer.create(quiz111.this,R.raw.cor);
                    son.start();


                }else {
                    Toast.makeText(quiz111.this, "Faux", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
