...
public class quiz222 extends Activity {
 ...
 /*Random r;
    ...
    private Question222 mQuestionLibrary = new Question222();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonChoice3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(quiz222.this,t222.class));
            }
        });
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(quiz222.this, "correcte", Toast.LENGTH_SHORT).show();
                    son= MediaPlayer.create(quiz222.this,R.raw.cor);
                    son.start();



                }else {
                    Toast.makeText(quiz222.this, "Faux", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
